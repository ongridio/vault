...
> Source: [wiki.postgresql.org](https://wiki.postgresql.org/wiki/Tuning_Your_PostgreSQL_Server)
> Author: PostgreSQL Project
> License: postgresql-license
> Fetched: 2026-05-18
...
- log_min_duration_statement: Not necessary for everyday use, but this can generate [logs of "slow queries"](/wiki/Logging_Difficult_Queries "Logging Difficult Queries") on your system.
...
There are also external tools such [pgbadger](https://pgbadger.darold.net/) that can analyze Postgres logs, see [Monitoring](/wiki/Monitoring "Monitoring") for a comprehensive list.
