...
> Source: [man7.org](https://man7.org/linux/man-pages/man7/epoll.7.html)
> Author: Linux Man Pages
> License: gpl-docs
> Fetched: 2026-05-18
...
```
   ...
   Interaction with autosleep
       ...
       will keep the device awake only until that event is queued.  To
   ...
   Example for suggested usage
       ...
       triggered usage requires more clarification to avoid stalls in the
       application event loop.  In this example, listener is a
       ...
       it will continue to read(2) or write(2) from where it stopped
       before.
   ...
   Questions and answers
       ...
       •  What happens if you register the same file descriptor on an
          ...
          duplicate (dup(2), dup2(2), fcntl(2) F_DUPFD) file descriptor
       ...
       •  Will closing a file descriptor cause it to be removed from all
          ...
          a reference to an open file description (see open(2)).
...
[epoll_create(2)](../man2/epoll_create.2.html), 
[epoll_ctl(2)](../man2/epoll_ctl.2.html), 
[epoll_wait(2)](../man2/epoll_wait.2.html), 
[eventfd(2)](../man2/eventfd.2.html), 
[FUTEX_FD(2const)](../man2/FUTEX_FD.2const.html), 
[ioctl_eventpoll(2)](../man2/ioctl_eventpoll.2.html), 
[io_uring_enter2(2)](../man2/io_uring_enter2.2.html), 
[io_uring_enter(2)](../man2/io_uring_enter.2.html), 
[kcmp(2)](../man2/kcmp.2.html), 
[open(2)](../man2/open.2.html), 
[perf_event_open(2)](../man2/perf_event_open.2.html), 
[perfmonctl(2)](../man2/perfmonctl.2.html), 
[pidfd_open(2)](../man2/pidfd_open.2.html), 
[poll(2)](../man2/poll.2.html), 
[recv(2)](../man2/recv.2.html), 
[seccomp_unotify(2)](../man2/seccomp_unotify.2.html), 
[select(2)](../man2/select.2.html), 
[select_tut(2)](../man2/select_tut.2.html), 
[signalfd(2)](../man2/signalfd.2.html), 
[timerfd_create(2)](../man2/timerfd_create.2.html), 
[userfaultfd(2)](../man2/userfaultfd.2.html), 
[sd-event(3)](../man3/sd-event.3.html), 
[sd_event_add_io(3)](../man3/sd_event_add_io.3.html), 
[sd_event_get_fd(3)](../man3/sd_event_get_fd.3.html), 
...
[fanotify(7)](../man7/fanotify.7.html), 
[inotify(7)](../man7/inotify.7.html), 
[mq_overview(7)](../man7/mq_overview.7.html), 
[pipe(7)](../man7/pipe.7.html), 
