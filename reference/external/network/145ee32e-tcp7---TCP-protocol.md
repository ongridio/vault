...
> Source: [man7.org](https://man7.org/linux/man-pages/man7/tcp.7.html)
> Author: Linux Man Pages
> License: gpl-docs
> Fetched: 2026-05-18
...
```
       ...
       /proc/sys/net/ipv4/tcp_wmem and /proc/sys/net/ipv4/tcp_rmem files,
       ...
       /proc file values reflect the larger sizes compared to the actual
       TCP windows.  On individual connections, the socket buffer size
       must be set prior to the listen(2) or connect(2) calls in order to
   ...
   /proc interfaces
       ...
       directory /proc/sys/net/ipv4/.  In addition, most IP /proc
       ...
       tcp_abc (Integer; default: 0; Linux 2.6.15 to Linux 3.8)
              ...
              (cwnd) more slowly in response to partial acknowledgements.
              Possible values are:
              ...
              2      allow increase cwnd by two if acknowledgement is of
       ...
       Linux 2.4.20)
              ...
              tcp_available_congestion_control.  The default value for
       ...
       tcp_frto_response (integer; default: 0; since Linux 2.6.22)
              ...
              2      Aggressive response; undoes congestion-control
                     ...
                     that would require TCP to be more cautious); cwnd
                     and ssthresh are restored to the values prior to
                     timeout.
       ...
       tcp_max_syn_backlog (integer; default: see below; since Linux 2.2)
              ...
              table (TCP_SYNQ_HSIZE) in include/net/tcp.h should be
              modified to keep
       ...
       2.6.6)
              ...
              tcp_no_metrics_save is enabled, TCP will not cache metrics
   ...
   Socket options
       ...
       TCP_SAVE_SYN (since Linux 4.3)
              Saves incoming SYN packet contents of the listening socket
              until it is read with TCP_SAVED_SYN once.  Could be set
              before or after the listen(2) call.

       TCP_SAVED_SYN (since Linux 4.3)
              Reads SYN packet contents saved by TCP_SAVE_SYN.  The saved
              SYN headers are freed after the first call.  The data
              returned in TCP_SAVED_SYN are network (IPv4/IPv6) and TCP
              headers.
       ...
       TCP_FASTOPEN (since Linux 3.6)
              ...
              the data and the SYN sequence.  accept(2) returns a socket
              ...
              net.ipv4.tcp_fastopen (see above).  For TCP Fast Open
       ...
       TCP_FASTOPEN_CONNECT (since Linux 4.11)
              ...
              connect(2) would behave differently depending on if a Fast
   ...
   Sockets API
       ...
       argument of recv(2) (and recvmsg(2)).  This flag causes the
   ...
   Ioctls
       ...
       SIOCATMARK
              ...
              select(2) (using the exceptfds argument) or through
...
[sendfile(2)](../man2/sendfile.2.html), 
[socket(2)](../man2/socket.2.html), 
[splice(2)](../man2/splice.2.html), 
[sockatmark(3)](../man3/sockatmark.3.html), 
[lloadd.conf(5)](../man5/lloadd.conf.5.html), 
[proc_sys_net(5)](../man5/proc_sys_net.5.html), 
[services(5)](../man5/services.5.html), 
[slapd.conf(5)](../man5/slapd.conf.5.html), 
[slapd-config(5)](../man5/slapd-config.5.html), 
[systemd.socket(5)](../man5/systemd.socket.5.html), 
[ip(7)](../man7/ip.7.html), 
[sock_diag(7)](../man7/sock_diag.7.html), 
[socket(7)](../man7/socket.7.html), 
[udp(7)](../man7/udp.7.html), 
[lttng-relayd(8)](../man8/lttng-relayd.8.html)
