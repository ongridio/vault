---
title: Integration Guide for Centralized Control¶
source: http://docs.openvswitch.org/en/latest/topics/integration/
kind: external
domain: network
original_date: 2023-01-01
fetched_at: 2026-05-16
bookmark_title: Integration Guide for Centralized Control — Open vSwitch 2.8.90 documentation
tags: [external, network]
---

> [!info] 外部文章 · 自动导入
> 来源：[docs.openvswitch.org](http://docs.openvswitch.org/en/latest/topics/integration/)
> 原始日期：2023-01-01
> 抓取日期：2026-05-16
...
. Information on the C bindings is available at
`lib/ovsdb-idl.h`
...
key uniquely identifies a particular bridge.
