...
tags: [external, kubernetes]
---

> [!info] External article · imported reference
> Source: [kubernetes.io](https://kubernetes.io/docs/tasks/administer-cluster/dns-debugging-resolution/)
> Author: Kubernetes
> License: cc-by-4.0
> Fetched: 2026-05-18
...
[addon](/docs/concepts/cluster-administration/addons/ "Resources that extend the functionality of Kubernetes.")
