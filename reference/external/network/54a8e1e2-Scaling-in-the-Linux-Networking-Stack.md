...
source: https://www.kernel.org/doc/html/latest/networking/scaling.html
kind: external
domain: network
author: Linux Kernel
license: gpl-docs
...
> Source: [www.kernel.org](https://www.kernel.org/doc/html/latest/networking/scaling.html)
> Author: Linux Kernel
> License: gpl-docs
> Fetched: 2026-05-18
...
a driver sends a packet up the network stack with [`netif_rx()`](kapi.html#c.netif_rx "netif_rx") or
[`netif_receive_skb()`](kapi.html#c.netif_receive_skb "netif_receive_skb"). These call the `get_rps_cpu()` function, which
...
CPU. [SMP IRQ affinity](../core-api/irq/irq-affinity.html) explains how CPUs are assigned to
the bitmap.
