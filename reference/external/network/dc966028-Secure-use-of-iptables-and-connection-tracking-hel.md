---
title: Secure use of iptables and connection tracking helpers
source: https://home.regit.org/netfilter-en/secure-use-of-helpers/
kind: external
domain: network
original_date: 2012-10-20
fetched_at: 2026-05-16
bookmark_title: Secure use of iptables and connection tracking helpers » To Linux and beyond !
tags: [external, network]
---

> [!info] 外部文章 · 自动导入
> 来源：[home.regit.org](https://home.regit.org/netfilter-en/secure-use-of-helpers/)
> 原始日期：2012-10-20
> 抓取日期：2026-05-16
...
Please note that if you are using the ports=0 solution, this will cause a renaming of the conntrack helper which will
